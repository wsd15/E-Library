    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="name" class="block mt-1 w-full" placeholder="Your Name" type="text" name="name" :value="old('name')" required autofocus />
            </div>
            ...
            <div class="mt-3">
                ...
                <x-input id="email" class="block mt-1 w-full" placeholder="Your Email" type="email" name="email" :value="old('email')" required />
            </div>
